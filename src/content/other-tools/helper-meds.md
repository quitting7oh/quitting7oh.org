...
[An alpha-2 adrenergic agonist that blocks the noradrenergic surge driving most physical withdrawal symptoms](https://www.addictioncenter.com/treatment/medications/clonidine/). It's the most widely-used non-opioid withdrawal medication, with [robust evidence going back decades](https://www.cochrane.org/evidence/CD002024_clonidine-lofexidine-and-similar-medications-management-opioid-withdrawal).

**What it helps:** sweating, tachycardia, hot/cold flashes, runny nose/eyes, anxiety, restlessness, mild insomnia, abdominal cramps.

**Typical dosing:** [0.1 to 0.2 mg orally every 6 to 8 hours](https://www.oregonpainguidance.org/wp-content/uploads/2020/03/Medications-to-Treat-Opioid-Withdrawal-Symptoms.pdf), often dosed 2-4 times daily. Average treatment duration about 15 days for acute withdrawal, then taper off.
...
**Promethazine (Phenergan)** is older but effective, with the bonus of significant sedation, useful if nausea is keeping you awake. **Caveat:** it's a first-gen antihistamine that can [worsen restless legs](https://pubmed.ncbi.nlm.nih.gov/15165526/), and it carries an [FDA black box warning for the injectable form](https://pubmed.ncbi.nlm.nih.gov/26125161/). The oral version is fine for most people, but if you have RLS symptoms, ondansetron is the better choice.
...
Withdrawal often brings diarrhea, but a lot of people hit the reverse, either before quitting (opioids are constipating by nature) or as things swing back during recovery. Opioid-induced constipation is miserable and worth treating proactively rather than waiting it out.
...
**[Baclofen](https://www.the-hospitalist.org/hospitalist/article/36857/key-clinical-questions/which-non-opioid-medications-are-best-for-symptom-management-in-ows/)** is a GABA-B receptor agonist used for muscle spasticity. In withdrawal contexts it helps with the muscle aches, restless legs, body tension, and (per [some studies](https://www.cochrane.org/CD007522/ADDICTN_medications-management-opium-withdrawal)) may reduce cravings post-acute too.

**Typical dosing:** [5 mg three times daily, can increase to 40 mg/day total](https://www.oregonpainguidance.org/wp-content/uploads/2020/03/Medications-to-Treat-Opioid-Withdrawal-Symptoms.pdf). Some prescribers continue baclofen post-acute for craving reduction.
...
**Hydroxyzine (Atarax/Vistaril)** is a non-controlled antihistamine for anxiety and sleep. **Caveat:** as a first-gen antihistamine, [it can worsen restless legs](https://pubmed.ncbi.nlm.nih.gov/15165526/). If you have RLS, skip this and use trazodone or doxepin instead.
...
**Mirtazapine (Remeron)** at 7.5-15 mg deserves its own callout. [A 2023 review proposed it as a "one-stop strategy" for opioid withdrawal](https://pmc.ncbi.nlm.nih.gov/articles/PMC10509332/) because it covers nausea, vomiting, anxiety, insomnia, and depression simultaneously. Single med, multiple symptoms covered, non-addictive. Worth asking your prescriber about.
...
**Helper meds are real tools, not extras.** The right combination changes how survivable withdrawal feels. Most people benefit from 2-4 of these, not 8.

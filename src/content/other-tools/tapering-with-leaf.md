...
description: "For some users in this community, plain kratom leaf powder can be used as a taper tool to come off 7-OH and other concentrated kratom-derived products. The…"
...
**This works best for users currently at lower daily 7-OH equivalent doses.** Heavier users typically need pharmaceutical support (Suboxone, see [#suboxone-info](/mat-suboxone/suboxone-info)) or SR-17018 to bridge through. **The two paths covered here:**
...
- **White vein** comes from younger leaves with [more mitragynine and less 7-OH](https://kratomspot.com/blog/the-ultimate-guide-to-red-kratom). More stimulating, less sedating. Useful late in the taper.

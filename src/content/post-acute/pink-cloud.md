...
If you're a couple of weeks into recovery and unexpectedly feel really good — clear-headed, optimistic, maybe even euphoric — you're not imagining it. There's a name for it: **the pink cloud.** It comes out of the AA tradition, where psychiatrist Harry Tiebout described it in a [1955 essay](https://www.barefootsworld.org/aa-pinkcloud.html). It isn't a clinical diagnosis, but it's a recognizable experience that a lot of people in recovery have hit.

After the worst of acute withdrawal, some people find themselves in a stretch where everything feels easier than it should. The fog lifts. The mood lifts. There's actual energy, sometimes more than you remember in years. You start to think this might actually work.

It's real. It's normal. And it's a window — not just to enjoy, but to use.

## What it is

Sudden optimism. Sometimes outright euphoria. Energy that feels almost surprising. Gratitude. A sense that things are clicking — that the obstacles you've been staring at are smaller than they looked. Some people describe it as the first time they've felt genuinely good in years.
...
- **Don't drop medications, therapy, or recovery practices because you feel fine.** This is the most common pink-cloud regret. The cloud convinces a lot of people they don't need the supports they actually do. Keep them. The supports are part of why you feel fine.
...
- **HPA axis settling.** The stress-response system, chronically activated by dependence and acute withdrawal, begins normalizing. Cortisol drops. Sleep improves. Anxiety reduces. Of the mechanisms here, this one has the most [peer-reviewed support](https://pubmed.ncbi.nlm.nih.gov/19016181/), though it has not been specifically linked to the pink-cloud construct.
- **The reward system slowly coming back online.** Receptor adaptation and dopamine signaling recover post-abstinence, but on a months-long timeline that doesn't really match the early pink-cloud window — so this is probably part of the broader recovery picture rather than the cause of the early bloom. See [Dopamine Recovery](/post-acute/dopamine-recovery) for the focused page.

---
title: "FMLA & Workplace Protections (for caregivers)"
...
The **[Family and Medical Leave Act](https://www.dol.gov/agencies/whd/fmla)** (FMLA) is a federal law that gives eligible employees up to **12 weeks of unpaid, job-protected leave per year** for specific qualifying reasons. During FMLA leave:
...
FMLA covers leave to care for a spouse, child (under 18, or adult if disabled under the [ADA](https://www.ada.gov)), or parent with a **serious health condition** — which includes inpatient care, continuing treatment for substance use disorder, and ongoing supervised treatment. SUD treatment qualifies; supporting someone *while they are using but not in treatment* generally does not.

The practical implications matter:

- **Spouse, parent, or minor child:** covered, broadly. Their SUD treatment is a qualifying reason.
- **Adult child:** only if they have a disability under the [ADA](https://www.ada.gov). Addiction in active recovery (in treatment, not currently using) often qualifies as a disability under the ADA; active use generally does not. Talk to an HR lawyer or legal aid if this is your situation.
...
The federal [Department of Labor](https://www.dol.gov) maintains a state-by-state overview at [dol.gov/agencies/whd/state](https://www.dol.gov/agencies/whd/state). For your specific state's program, search "[state name] paid family leave" — most have a dedicated website with eligibility, benefit amount, and how to apply.
...
**[HIPAA](https://www.hhs.gov/hipaa/index.html) protections:** your loved one's medical information stays between them and their providers. The certification form goes to your HR, but the underlying medical record does not. HR cannot demand the medical record itself.
...
- **If your employer pushes back wrongly:** the federal [Wage and Hour Division](https://www.dol.gov/agencies/whd) ([1-866-487-9243](https://www.dol.gov/agencies/whd/contact)) investigates FMLA complaints. State labor agencies handle state-law equivalents.

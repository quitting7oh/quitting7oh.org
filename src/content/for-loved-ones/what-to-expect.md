...
The [CRAFT framework](/for-loved-ones/how-to-talk#craft), covered on the next page, is the evidence-based version of this. It outperforms both [Al-Anon](https://al-anon.org) and the confrontational Johnson Intervention in clinical trials for getting a loved one into treatment, and it does so without requiring you to cut them off or stage a dramatic ultimatum.

## Where to read next

- **[How to Talk to Your Loved One](/for-loved-ones/how-to-talk)**: concrete conversation skills and CRAFT
- **[Boundaries Without Punishment](/for-loved-ones/boundaries)**: what to do when the talking has limits
- **[Taking Care of Yourself](/for-loved-ones/taking-care-of-yourself)**: because you can't pour from an empty cup

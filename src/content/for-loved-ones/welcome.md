...
Loving someone in addiction is hard. You deserve support too.

If you found this site because your partner, child, parent, sibling, or close friend is using "gas station pills," "[7-OH](/compounds/7-oh) tablets," or anything in that family, take a breath. You don't need to fix everything tonight. The information here is meant to help you understand what you're dealing with, because the marketing on these products has misled almost everyone, including most clinicians.

You may be feeling exhausted, scared, furious, hypervigilant, guilty, or some rotating combination of all of those. None of that is weakness or overreaction. Those are normal responses to watching someone you love disappear inside a chemical dependency, and to the day-to-day work of trying to keep things from getting worse. The fact that you're here, reading, is itself a form of taking care.

## The 3 Cs (and the C that matters more)

The most useful frame for family members in this situation, repeated for decades because it keeps being true:

- **You didn't cause it.**
- **You can't control it.**
- **You can't cure it.**

The fourth, from the [CRAFT](/for-loved-ones/how-to-talk#craft) approach: **but you can influence the environment, and you can take care of your own life.** That's the practical work this section is about.

## What's in this section

The pages in this section walk through, in roughly the order most families need them:

- **[What to Expect](/for-loved-ones/what-to-expect)**: the shape of dependence, withdrawal, and recovery (including the long tail almost nobody warns families about).
- **[How to Talk to Your Loved One](/for-loved-ones/how-to-talk)**: what tends to land, what tends to backfire, and the evidence-based CRAFT framework.
...
Your loved one isn't taking a supplement. [7-hydroxymitragynine (7-OH)](/compounds/7-oh) is a potent mu-opioid receptor agonist, the same receptor family as prescription opioids. The newer synthetics ([MGM-15](/compounds/mgm15), [pseudoindoxyl](/compounds/mitragynine-pseudoindoxyl)) are even more potent, and most don't show up on standard drug tests. Withdrawal looks like opioid withdrawal because biochemically, that's what it is.
...
If they're unresponsive, breathing slowly, or you can't wake them: **give naloxone (Narcan) if you have it and call 911.** Detailed instructions are on the [Safety page](/for-loved-ones/safety#naloxone-narcan).

...
These read like the back of a cereal box, and they actually matter:
...
If you're going to pay for therapy (or use insurance, or use an [EAP](/for-loved-ones/fmla-workplace#employee-assistance-programs-eaps) session), the type of therapist matters:
...
- **CRAFT-trained therapists** exist. [Allies in Recovery](https://www.alliesinrecovery.net) maintains a directory; SMART Recovery's site has some referrals; asking local addiction medicine practices for family-side therapist recommendations is another route.
...
- **Open Path Collective** ([openpathcollective.org](https://openpathcollective.org)) is a directory of therapists who offer sessions at $40–$80 with no insurance.
- **[Inclusive Therapists](https://www.inclusivetherapists.com), [Therapy for Black Girls](https://therapyforblackgirls.com), [Latinx Therapy](https://latinxtherapy.com)** — community directories that center specific identities and often have sliding-scale providers.
...
See [Support Groups for Family & Friends](/for-loved-ones/support-groups) for the full directory. The short version: try more than one. Different fellowships have very different cultures, and "this isn't for me" after one meeting at one group rarely generalizes.
...
**Your suffering does not help them.** It does not get added to a karmic ledger that subtracts from their misery. It does not make recovery come faster. It just hurts you, and the hurt to you compounds over time in ways that diminish your capacity to be useful when they actually need you.
...
- **[Support Groups for Family & Friends](/for-loved-ones/support-groups)** — the peer-support directory
- **[Boundaries Without Punishment](/for-loved-ones/boundaries)** — easier to keep when your own life is intact
- **[Safety](/for-loved-ones/safety)** — when "self-care" means leaving

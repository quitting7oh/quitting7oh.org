...
- **Discord:** [discord.gg/quitting7oh](https://discord.gg/quitting7oh). Fastest. Anyone in the moderator channels will see it; tag a mod if it's urgent.
- **Subreddit:** post on [/r/quitting7oh](https://www.reddit.com/r/quitting7oh/), or [send modmail](https://www.reddit.com/message/compose?to=/r/quitting7oh) for something that should reach the whole team privately.
- **Email:** [feedback@quitting7oh.org](mailto:feedback@quitting7oh.org).
...
This is the case where we most want to hear from you. AI-assisted content can produce subtle errors, miss context, or use phrasing that lands worse than intended. If something on the site reads as actually harmful — minimizing a real danger, recommending something risky without warning, using language that punches down on someone going through this — please flag it. Either:
...
- **No fast response times.** Mods are volunteers with their own lives and recoveries. Expect hours-to-days, not minutes — except in the live `#sos` channel on Discord, which is staffed more actively.

## Credit and acknowledgement

If you've contributed content, code, or substantial review effort, we'll credit you on the [Community page](/about/community) — or omit you if you'd rather stay uncredited. Pseudonyms are completely fine; most of us go by handles in this space anyway.

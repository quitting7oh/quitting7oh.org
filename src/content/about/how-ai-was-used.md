...
- The Subs↔SR-17 pairing rule. When the writing is routing someone, [Suboxone](/mat-suboxone/suboxone-for-7oh) and [SR-17018](/other-tools/sr-17) are named together. Naming one without the other implies the named one is the "real" answer. A page about Suboxone itself can stay focused on Suboxone; routing language triggers the pairing.

...
- The path-pairing rule. When the writing is routing someone, [Suboxone](/mat-suboxone/suboxone-for-7oh) is never the only option named; [tapering with kratom leaf](/other-tools/quit-7-oh-with-kratom-leaf) and cold turkey with [helper medications](/other-tools/helper-meds) appear alongside it. Naming one path without the others implies the named one is the "real" answer. This rule paired Suboxone with [SR-17018](/other-tools/sr-17) until August 2026, when SR-17 went into Schedule I and stopped being a path a reader could take.
...
- Only route to a clinician for things a clinician will engage with. Sending a reader to telehealth for a cannabis question or an SR-17018 taper wastes their time. The page names what a clinician will actually help with, and routes community-territory topics back to peers and the Discord.

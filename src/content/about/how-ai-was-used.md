...
- Only route to a clinician for things a clinician will engage with. Sending a reader to telehealth for a cannabis question or an LDN protocol wastes their time. The page names what a clinician will actually help with, and routes community-territory topics back to peers and the Discord.

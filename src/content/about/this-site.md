...
quitting7oh.org is a community-compiled reference for getting off [7-OH](/compounds/7-oh), [MGM-15](/compounds/mgm15), and other kratom-derived synthetics. It grew out of conversations in our [Discord and subreddit](/about/the-community). The team organized what community members learned so the next reader can find answers without searching through hundreds of Reddit posts.
...
Most of the writing on this site went through an LLM. Community experience supplied the source material. Maintainers and moderators have used and withdrawn from [7-OH](/compounds/7-oh) and kratom synthetics, and they have spent more than a year helping others through the same process.
...
The full set of instructions lives in [CLAUDE.md](https://github.com/quitting7oh/quitting7oh.org/blob/main/CLAUDE.md) in the public repository. It records the site's medical framing, source requirements, language rules, and limits on what the model can claim.
...
The team runs each draft through the [stop-slop ruleset](https://github.com/quitting7oh/quitting7oh.org/blob/main/docs/stop-slop/SKILL.md). The site keeps a local copy in [docs/stop-slop](https://github.com/quitting7oh/quitting7oh.org/tree/main/docs/stop-slop), based on [Hardik Pandya's MIT-licensed project](https://github.com/hardikpandya/stop-slop).
...
AI can produce errors. If you find a factual mistake, unsafe recommendation, or missing context, open an issue or pull request on [GitHub](https://github.com/quitting7oh/quitting7oh.org) or use a channel listed on [Contributing & Feedback](/about/contributing).
...
- **[Start Here](/start-here/welcome):** recovery information and next steps
- **[The Community](/about/the-community):** the Discord, subreddit, and current volunteer team
- **[Contributing & Feedback](/about/contributing):** corrections, proposed changes, and contact routes
- **[Where the Site Stands](/about/where-we-stand):** the site's position on kratom leaf, synthetics, and scheduling

...
Seven compounds, six structurally related to mitragynine plus
...
group at C-7** raises affinity dramatically (mitragynine → 7-OH),
and **reduction (saturating a double bond)** consistently raises
affinity by adding conformational flexibility that lets the
molecule fit the receptor more tightly.
...
| **Reduction** (+H₂) of side-chain C=C | Mitragynine | Dihydro-mitragynine (DHM / MIT-A) | Saturated bond adds conformational flexibility; moderate affinity gain |
...
**A note on this list's scope.** The seven compounds above aren't

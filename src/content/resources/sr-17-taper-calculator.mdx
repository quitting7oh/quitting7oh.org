...
description: "Build a simple 7, 10, or 14-day 7-OH to SR-17 cross-taper, or switch to the configurable advanced calculator. Kept for readers already mid-taper after SR-17018 went into Schedule I."
category: "resources"
...
> legally start. See [SR-17](/medications-supplements/sr-17) for what
> the order covers and what to do if you're partway through.
...
- It doesn't tell you what to do instead. [Suboxone](/mat-suboxone/suboxone-for-7oh), [tapering with kratom leaf](/medications-supplements/quit-7-oh-with-kratom-leaf), and cold turkey with [helper medications](/medications-supplements/helper-meds) are the paths still open.

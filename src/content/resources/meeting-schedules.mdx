...
description: "Live meeting schedules for the two kratom-specific fellowships — Kratom Anonymous (12-step) and Quitting Kratom Support - There Is A Way Out / TIAWO (non-12-step). Day, time, format, join links."
category: "resources"
last_updated: "2026-08-11"
sort: 3
---
import MeetingsTable from '~/components/MeetingsTable.astro';
import { PreviouslyJoinedMeetings } from '~/components/PreviouslyJoinedMeetings';

This page is the schedule for the two peer support fellowships focused specifically on kratom, kratom extracts, and [7-OH](/compounds/7-oh): **Kratom Anonymous (KA)**, a 12-step fellowship, and **Quitting Kratom Support - There Is A Way Out (TIAWO)**, a non-12-step volunteer-led community. Both are listed below with day, time, format, and join links, pulled from the fellowships' own sites.

<PreviouslyJoinedMeetings providers={['KA', 'KQS']} client:load />
...
## Quitting Kratom Support - There Is A Way Out (TIAWO), full schedule

Quitting Kratom Support - There Is A Way Out (TIAWO) is a volunteer-led, **non-12-step** virtual community focused on kratom and 7-OH recovery. Source: [kratomquitters.com/meetings](https://kratomquitters.com/meetings). Meetings run on Google Meet and are open to both people in recovery and their loved ones.

<MeetingsTable fellowship="KQS" />

### Notes on the TIAWO schedule

- **Most meetings share a single Google Meet room** ([cza-tyjv-fun](https://meet.google.com/cza-tyjv-fun)); the morning, midday, afternoon, newcomers, evening, and late-evening slots all use it. The Sunday men's, women's, and LGBTQ+ meetings each have their own room.
...
- **[Community](/about/the-community)**: the quitting7oh Discord and subreddit (complements mutual aid attendance)

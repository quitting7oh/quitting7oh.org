...
The SR-17 protocol is structurally different from the rest — it's a **cross-taper**, not a single-substance taper. You preload SR while staying on 7-OH (or MGM-15 / MIT-A / pseudo), step the 7-OH to zero with SR carrying you, hold on SR-only, then taper the SR down. The calculator has four configurable phases plus an optional allergy-test day. See the [SR-17 page](/medications-supplements/sr-17) for the full protocol before running the math.

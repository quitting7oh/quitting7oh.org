...
> **What this page is.** A neutral, sourced look at NAD+ IV therapy as
> it's sold and used in recovery contexts. NAD+ infusions are
> investigational, not FDA-approved for any addiction indication, and
> not standard of care. The published clinical evidence is thin and
> mostly comes from clinicians who run the NAD+ infusion clinics.
> People still pay for it; some report meaningful benefit; the page
> exists because readers ask.
>
> The first half describes what's offered, where, and at what cost.
> The second half describes what the evidence actually supports.
...
For sourcing, see [Vitamins & Supplements](/medications-supplements/vitamins-supplements). Third-party testing certifications (USP, NSF, ConsumerLab) exist for readers who want to evaluate supplement quality without specific-brand endorsements.
...
This site does not link to specific providers and does not recommend any clinic. See [Where we stand](/about/where-we-stand) for the broader posture on this kind of question.
...
The [NPR investigation cited below](https://www.npr.org/sections/health-shots/2019/08/22/741115178/addiction-clinics-market-unproven-infusion-treatments-to-desperate-patients) documented one clinic charging $15,000 for a 10- to 15-day course. Pricing varies by region, clinic, and add-ons.
...
**Pilot case series, uncontrolled.** [Blum et al. 2022 (PMID 36118157)](https://pubmed.ncbi.nlm.nih.gov/36118157/) reported on 50 SUD patients given a proprietary NAD+ formulation, with pre/post improvements in craving, anxiety, and depression. No control group, no blinding. Author affiliations include commercial NAD+ ventures and patent-holding interests. A 2024 republication in [*J Addict Psychiatry* (PMID 39949994)](https://pmc.ncbi.nlm.nih.gov/articles/PMC11823434/) appears to draw on the same patient cohort.
...
For a far cheaper withdrawal adjunct with a more-established (though still preliminary) literature behind it, see [Mega-Dose Vitamin C](/medications-supplements/mega-dose-vitamin-c).
...
The decision itself is closer to community ground than clinic ground. The most useful conversation is usually with someone who has done a course and can describe what the experience was like, what they paid, and what they think they got. The [Discord](https://discord.gg/quitting7oh) and [r/quitting7oh](https://www.reddit.com/r/quitting7oh/) are reasonable starting points.

For drug-interaction questions about your other medications, a prescriber is the right address.

## Further reading

- **[Mega-Dose Vitamin C](/medications-supplements/mega-dose-vitamin-c)**: a far cheaper adjunct with older and stronger preliminary literature
- **[Peptides for Opioid Withdrawal](/medications-supplements/peptides-for-withdrawal)**: BPC-157, Selank, Semax, DSIP, TB-500; what the evidence supports per peptide and the supply-chain safety reality
- **[Vitamins & Supplements](/medications-supplements/vitamins-supplements)**: supplement stack background and sourcing notes

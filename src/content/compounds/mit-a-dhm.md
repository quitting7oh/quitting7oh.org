...
- > **Big harm-reduction note:** products labeled "DHM" have been found containing [7-OH](/compounds/7-oh) and other unlabeled compounds. Some vendor labels actually disclose this in the fine print. **What's on the label is not necessarily what's in the bottle.**
...
## What it is
MIT-A, sold and discussed as **DHM (dihydromitragynine)**, is a semi-synthetic compound — the 1,2-dihydro reduction product of mitragynine itself, *not* of 7-OH. It is **not** the same as [MGM-15](/compounds/mgm15) (which is the dihydro form of 7-OH and is also sometimes called "DHM" in academic papers — naming in this space is genuinely a mess, so when in doubt, ask).

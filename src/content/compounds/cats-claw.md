...
Cat's claw (*Uncaria tomentosa*) and kratom (*Mitragyna speciosa*) [are both in the Rubiaceae family](https://en.wikipedia.org/wiki/Mitraphylline), which also includes coffee. They're botanical cousins, not the same plant. They share a few alkaloids in common, particularly **mitraphylline** and **rhynchophylline**, both of which [appear in cat's claw and in trace amounts in kratom](https://www.kratomscience.com/mitragyna-speciosa-kratom-alkaloids-effects/).
...
*Uncaria tomentosa* is [traditionally used as an anti-inflammatory and immune-support herb](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12296035/), and [a 2026 study examining its main alkaloids (mitraphylline, rhynchophylline, and related compounds) found they don't show measurable binding at opioid receptors on their own](https://www.frontiersin.org/journals/pharmacology/articles/10.3389/fphar.2026.1763551/full). It does not produce euphoria, sedation, or pain relief like an opioid. If a "Cat's Claw" product is hitting you like one, something else is in it.

## What's actually in these products
Lab testing on the new "Cat's Claw" product lines suggests they contain:
- **[MGM-15](/compounds/mgm15)** or **MGM-16** (semi-synthetic opioids derived from [7-OH](/compounds/7-oh))

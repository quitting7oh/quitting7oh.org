...
> **Last verified against primary sources on August 21, 2026.** This page
> tracks a live regulatory action; we'll update it as things move.

## Status: not banned yet

**As of August 21, 2026, nothing is banned.** DEA has not issued the
...
| **August 21, 2026** | Latest check against the Federal Register: still no scheduling order. The ban is not in effect. |
...
comments submitted**. As of August 21,

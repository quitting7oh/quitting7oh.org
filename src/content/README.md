...
src/content/resources/quickmd-info.md → quitting7oh.org/resources/quickmd-info
```
...
3. Paste this front matter at the top of the file and fill it in:
       ...
       last_updated: "2026-05-21"       # ISO date (YYYY-MM-DD)
       source_channel: "#channel-name"  # optional, for provenance
       ---

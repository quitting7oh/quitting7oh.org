...
<DocTabs>
<DocTabPanel value="fmla" label="FMLA">
...
- **Your [EAP](#eaps--employee-assistance-programs)**, if you have one, doesn't go through HR and may cover counseling sessions and referrals at no cost regardless of FMLA eligibility. See the HR & Practical tab.
...
<DocTabPanel value="ada" label="ADA">
...
<DocTabPanel value="practical" label="HR & Practical">

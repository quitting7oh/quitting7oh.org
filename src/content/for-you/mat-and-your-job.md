...
For the vast majority of jobs, your prescriptions are protected medical information. Your employer does not have access to your treatment records. Your prescriber cannot release them without your written consent. [HIPAA](https://www.hhs.gov/hipaa/index.html) covers the medical-records side; the [ADA](https://www.ada.gov) covers most of the employment-discrimination side. The [For You: FMLA, ADA & Your Job](/for-you/fmla-ada-job) page covers this in detail.
...
These are mostly employer-level policies rather than government licensure. The [ADA](https://www.ada.gov) provides some protection for people on legally prescribed MAT, but employers retain meaningful latitude for safety-sensitive positions. Talk to an employment lawyer if a "safety-sensitive" designation is being used to exclude you.
...
Federal employment with a security clearance involves additional review of SUD history. The [SF-86 questionnaire](https://www.opm.gov/forms/pdf_fill/sf86.pdf) asks about treatment for drug use. Recent guidance has somewhat relaxed automatic disqualification for past or current MAT use in good-standing recovery, but the process is fact-specific and individualized.

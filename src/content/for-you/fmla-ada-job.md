...
The **[Family and Medical Leave Act](https://www.dol.gov/agencies/whd/fmla)** gives eligible employees up to **12 weeks of unpaid, job-protected leave per year** for their own serious health condition, which includes substance use disorder treatment.
...
Your medical information stays between you and your providers under [HIPAA](https://www.hhs.gov/hipaa/index.html). The FMLA certification goes to HR, but the underlying medical records do not. HR cannot demand or access your treatment records, and your providers cannot release them without your written consent.

## ADA — Americans with Disabilities Act

The **[ADA](https://www.ada.gov)** is separate from FMLA and provides different (overlapping) protections.
...
- Modified schedule to attend IOP, therapy, MAT appointments, or [AA](https://www.aa.org)/[NA](https://www.na.org)/equivalent.
...
The Department of Labor maintains a state-by-state overview at [dol.gov/agencies/whd/state](https://www.dol.gov/agencies/whd/state).
...
1. **Decide what you actually need.** Time off for inpatient? Reduced hours for IOP? A modified schedule for weekly MAT appointments? Knowing the ask makes the conversation cleaner.
...
The federal [Department of Labor's Wage and Hour Division](https://www.dol.gov/agencies/whd) ([1-866-487-9243](https://www.dol.gov/agencies/whd/contact)) investigates FMLA violations. The [EEOC](https://www.eeoc.gov) ([1-800-669-4000](https://www.eeoc.gov)) handles ADA complaints. State labor agencies handle state-law equivalents. Free initial consultations are widely available from employment attorneys.
...
- **State paid-leave programs.** Many states (CA, NY, NJ, MA, WA, OR, CT, RI, CO, DC, and others) have their own family/medical leave laws with lower eligibility thresholds and sometimes paid benefits. See the [Department of Labor's state-by-state overview](https://www.dol.gov/agencies/whd/state). Some of these cover smaller employers and shorter tenures than federal FMLA.
- **[ADA](https://www.ada.gov) reasonable accommodations.** The ADA applies to employers with 15+ employees (lower threshold than FMLA's 50). For employees in recovery or in treatment, requested accommodations like a modified schedule for treatment appointments are often grantable even when FMLA leave isn't available.
...
You don't owe anyone a story. "I had a health thing" or "I needed to take care of something" or simply "I was out on medical leave" are complete answers. The people who care will respect that, and the people who don't respect it weren't your friends in the meaningful sense.

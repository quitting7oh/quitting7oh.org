...
That argues for **careful vetting of specific houses**, not just confirming a home meets the formal criteria. The [Finding a legitimate home](#finding-a-legitimate-home) section below covers the formal vetting (NARR certification, referral conflicts, rules and contracts). The equally important informal vetting:
...
The **[National Alliance for Recovery Residences (NARR)](https://narronline.org)** defines four levels of recovery housing. Knowing these helps you compare options.
...
- **[Oxford House](https://www.oxfordhouse.org)** is the canonical Level I model (see below).
...
- **Some [Medicaid](https://www.medicaid.gov) waivers** in some states cover recovery housing as part of broader SUD service packages.
- **[SAMHSA](https://www.samhsa.gov)-funded recovery housing** exists in some areas via state Single State Agencies for substance use.
- **Religious or non-profit homes** are often lower-cost. [Salvation Army](https://www.salvationarmyusa.org/) and various faith-based ministries operate residential programs that include housing.
...
- **Requires you to sign over your benefits.** Some predatory homes take your SNAP benefits, your SSI/SSDI, your unemployment benefits, or your [Medicaid](https://www.medicaid.gov) managed-care choice in exchange for a bed. This is a sign you're being processed for billing, not housed for recovery.
...
**Website:** [oxfordhouse.org](https://www.oxfordhouse.org)

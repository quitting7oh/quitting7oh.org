...
### 18YearsOfRegret — May 2, 2026, 7:05 AM
...
- **Norbuprenorphine, an active metabolite, is a full agonist at the mu receptor and [does not have a ceiling on respiratory effects](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11303732/)**. This is part of why bupe combined with benzos or alcohol can lead to overdose.
...
This is the part most people aren't warned about. [A 2013 study comparing long-term Suboxone patients to the general population and to AA members found that long-term Suboxone patients showed significantly flat affect (statistically significant, p less than 0.01) and less self-awareness of being happy, sad, or anxious compared to both control groups](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3706486/). [Other research has documented that opioid users in general have abnormal emotional experience, characterized by heightened response to unpleasant stimuli and blunted response to pleasant stimuli](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3706486/).
...
This isn't depression in the clinical sense (though it can co-occur with depression). It's [a side effect of sustained mu-opioid receptor activation](https://salpsych.com/does-suboxone-cause-depression-or-anxiety/) and the downstream effects on the dopamine and reward systems. Many people don't notice it until they finally taper off and are surprised by how much color comes back.

### 18YearsOfRegret — May 2, 2026, 7:07 AM *(edited)*
...
- **Hormonal effects.** Sustained opioid receptor activation can lead to [hypogonadism (low testosterone, low libido, fatigue) and decreased libido](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC11303732/). This affects both men and women. Worth getting bloodwork if you've been on it for over a year.
...
- **Dental issues.** [Sublingual films and tablets are associated with dental caries and tooth loss](https://americanaddictioncenters.org/suboxone/side-effects). This isn't speculation, it's documented enough that the FDA added a warning. Rinse your mouth with water (not toothpaste, the acidity damages teeth) after every dose, wait 30 minutes before brushing.
...
- [Suboxone Withdrawal: Symptoms, Timeline & Detox](https://www.columbusrecoverycenter.com/drugs/suboxone-addiction/withdrawal-detox/)
- [Reddit-based research on stopping extended-release buprenorphine](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12064969/)
...
### 18YearsOfRegret — May 2, 2026, 7:22 AM
...
[A small case series reported on patients prescribed low-dose sublingual buprenorphine who were transitioned to a single 100 mg dose of Sublocade and then ceased treatment without eliciting opioid withdrawal symptoms](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12018199/). [Larger observational research has found mixed results, with some patients experiencing minimal withdrawal and others reporting protracted symptoms that ramped up weeks after the last injection](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12064969/).
...
-# Discussion of Suboxone use, withdrawal experiences, taper plans, and personal stories happens in **#suboxone**,
...
### 18YearsOfRegret — Apr 29, 2026, 6:53 PM
...
- **Telehealth platforms.** [AgelessRx](https://agelessrx.com/ldn/) is the most commonly mentioned one. Online intake, provider review, ships compounded LDN directly. Cash-pay, no insurance. Other telehealth options exist and the landscape changes fast; do your own research on what's reputable and available in your state.
- **Your own provider.** Primary care, addiction medicine, pain management, or functional medicine docs are the most likely to be familiar with LDN. The [LDN Research Trust](https://ldnresearchtrust.org/) maintains a provider directory and a pharmacy directory if your current doc isn't familiar with it. This is the single best independent resource if you want to go through your own healthcare instead of a telehealth platform.

Examples of compounding pharmacies that make LDN: [CareFirst Specialty Pharmacy](https://www.cfspharmacy.pharmacy/naltrexone-low-dose-compounded), [Valor Compounding](https://valorcompounding.com/low-dose-naltrexone/), Belmar Pharmacy, Pharmacy Solutions. Many others exist; your prescriber may already have a preferred one.
...
- [Therapeutic Uses and Efficacy of LDN: A Scoping Review (2024)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12017383/), recent overview of clinical evidence
- [Low-Dose Naltrexone, Review of Therapeutic Utilization](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6313374/), covers the proposed mechanism in detail
- [Early Outcomes Following Low Dose Naltrexone Enhancement of Opioid Detoxification](https://pmc.ncbi.nlm.nih.gov/articles/PMC3190236/), clinical study relevant to recovery use

### 18YearsOfRegret — Apr 29, 2026, 6:52 PM
...
- Some data on reduced relapse rates when used [post-detox](https://pmc.ncbi.nlm.nih.gov/articles/PMC3190236/)

...
### 18YearsOfRegret — May 2, 2026, 6:44 AM *(edited)*
...
1. **Sign up** at [quick.md](https://www.quick.md/) or via their iOS/Android app.
...
[Prescriptions go to a local pharmacy you choose](https://www.choosingtherapy.com/quickmd-review/), or QuickMD has a home delivery option in some states.

## Pricing (cash-pay only)
- **$99 per addiction treatment visit.** [First visit + 14-day follow-up: effectively $99 total to start treatment.](https://www.quick.md/)
- **Monthly follow-ups: $99 each.** This is the recurring cost as long as you're on treatment.
- **Counseling add-on: $45 for 30-minute sessions** (optional).
- **Medication cost is not included** and varies by pharmacy. [Brand-name Suboxone can run up to $500/month without insurance, but generics are significantly cheaper, often $30 to $80/month at major pharmacies with discount cards (GoodRx, etc.)](https://www.quick.md/quick-tips/how-much-does-suboxone-cost-without-insurance-top-3-ways-to-save/).
- **They don't accept insurance for visits**, but your insurance can still cover the medication at the pharmacy, and you can ask your provider to send the prescription wherever your coverage works best.

### 18YearsOfRegret — May 2, 2026, 6:48 AM *(edited)*
...
- **DEA-licensed providers** prescribing buprenorphine. Since [the X-waiver was eliminated in 2023](https://www.samhsa.gov/medications-substance-use-disorders/become-buprenorphine-waivered-practitioner), any DEA-licensed provider can prescribe bupe.
...
- **Subutex (buprenorphine-only)** in cases of documented allergy or naloxone sensitivity. [QuickMD defaults to Suboxone unless there's a clinical reason](https://www.quick.md/faqs/).
- **Helper medications for the non-opioid side of withdrawal**, sometimes. Bupe alone doesn't cover the noradrenergic, anxiety, and sleep symptoms that hit hard in early recovery (see **#why-suboxone-fails-archive**). QuickMD providers can sometimes prescribe adjuncts like:
  ...
  - **Hydroxyzine** — non-addictive antihistamine for anxiety and sleep. **Caveat:** as a first-gen H1 antagonist, it's been linked to [worsening RLS and other withdrawal symptoms](https://pubmed.ncbi.nlm.nih.gov/15165526/). If you have RLS, twitchy legs, or jumpy symptoms, it may make them worse. Switch to a different adjunct if so.
...
### 18YearsOfRegret — May 2, 2026, 6:49 AM *(edited)*
...
- **Bicycle Health** ([bicyclehealth.com](https://www.bicyclehealth.com/)) — accepts insurance, more structured program
- **Ophelia** ([ophelia.com](https://ophelia.com/)) — accepts insurance, includes care coordination
- **Workit Health** ([workithealth.com](https://www.workithealth.com/)) — accepts insurance, more comprehensive program with counseling
- **Boulder Care** ([boulder.care](https://boulder.care/)) — Medicaid-friendly in covered states
...
## Sources
- [QuickMD pricing](https://www.quick.md/pricing/)
- [QuickMD FAQs](https://www.quick.md/faqs/)
- [Choosing Therapy: QuickMD review](https://www.choosingtherapy.com/quickmd-review/)
- [QuickMD on Suboxone cost without insurance](https://www.quick.md/quick-tips/how-much-does-suboxone-cost-without-insurance-top-3-ways-to-save/)
- [Trustpilot reviews of QuickMD](https://www.trustpilot.com/review/quick.md)
...
-# This is a locked information channel. For discussion of telehealth MAT, induction stories, or to share your own QuickMD experience, see **#suboxone**.